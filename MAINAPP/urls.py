...
urlpatterns = [
	...
	#path('user_login/', LoginView.as_view(template_name='MAINAPP/login.html'), name='user_login'),
    ...
    path('ASDdiagnosis/', views.ASDdiagnosis,name='ASDdiagnosis'),
    path('ASDdiagnosis_result/', views.ASDdiagnosis_result,name='ASDdiagnosis_result'),
